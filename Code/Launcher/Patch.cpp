...
int PatchEnablePreordered( void *libCryNetwork, int gameVersion )
{
	...
	switch ( gameVersion )
	{
		...
		case 5767:
		{
			if ( FillMem( CalculateAddress( libCryNetwork, 0x17F0C7 ), code, sizeof code ) < 0 )
				return -1;
			break;
		}
		case 5879:
		{
			...
			if ( FillMem( CalculateAddress( libCryNetwork, 0x1765F0 ), code, sizeof code ) < 0 )
				return -1;
			break;
		}
		case 6115:
		{
			if ( FillMem( CalculateAddress( libCryNetwork, 0x17C077 ), code, sizeof code ) < 0 )
				return -1;
			break;
		}
		case 6156:
		{
			if ( FillMem( CalculateAddress( libCryNetwork, 0x17C377 ), code, sizeof code ) < 0 )
				return -1;
			break;
		}
	#else
		case 5767:
		{
			if ( FillMem( CalculateAddress( libCryNetwork, 0x42C10 ), code, sizeof code ) < 0 )
				return -1;
			break;
		}
		case 5879:
		{
			if ( FillMem( CalculateAddress( libCryNetwork, 0x412FD ), code, sizeof code ) < 0 )
				return -1;
			break;
		}
		case 6115:
		{
			if ( FillMem( CalculateAddress( libCryNetwork, 0x430A8 ), code, sizeof code ) < 0 )
				return -1;
			break;
		}
		case 6156:
		{
			if ( FillMem( CalculateAddress( libCryNetwork, 0x43188 ), code, sizeof code ) < 0 )
				return -1;
			break;
		}
	#endif
